...
I also need to get the family and genus for each species, for both, the names which came out of the matched or "new" (from the backbone) and for those we used to enter for those SPECIES.ORIG. I do so here, but at the end I need to reconstruct a new dataframe contaning all information from the data from Maria Judith, plus the following fields:
