...
```{r}
  ...
  # Run this to create all the outputs
  neotropical_epyphites_completeness <- result_df
  data(adworld)
  KnowB(data = neotropical_epyphites_completeness,
        format="A",
        cell=30,
        curve= "Exponential",
        estimator=1,
        ...
        colscale=c("#C8FFFFFF","#64FFFFFF","#00FFFFFF","#64FF64FF","#C8FF00FF"
                   ,"#FFFF00FF","#FFC800FF","#FF6400FF","#FF0000FF"),
        legend.pos="y", breaks=9, xl=0, xr=0, yb=0, yt=0, lab=NULL, xlab="Longitude",
        ...
        trans=c(1,1), log=c(0,0), ndigits=0, save="RData",
